...
#     steth.submit(brownie.ZERO_ADDRESS, {"from" :user, "value":5218401791438339199})
...
def add_liquidity_balanced_amounts(RELATIVE_APPROX, steth, user, steth_pool_lp_token, steth_pool, position_size_in_eth):
    ...
    steth_pool.add_liquidity([eth_amount, steth_amount_string], 0, {'from':user, 'value':eth_amount})
